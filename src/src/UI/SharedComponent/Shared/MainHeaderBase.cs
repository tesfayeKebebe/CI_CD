...
namespace SharedComponent.Shared
{
    ...
    { 
       ...
       var result=     await DialogService.OpenAsync<Login>("",
            new Dictionary<string, object>(),
            new DialogOptions { Width = "300px", Height = "100%", Style = "position: absolute; Top:80px; right:2px;" , CloseDialogOnOverlayClick = true });
            StateHasChanged();
        }
        ...
        protected async Task OnAccount()
        {
            var result=     await DialogService.OpenAsync<Account>("",
                new Dictionary<string, object>(),
                new DialogOptions {  Width = "300px", Height = "100%", Draggable = true, Resizable = true, Style = "position: absolute; Top:80px; right:2px;", CloseDialogOnOverlayClick = true});
            StateHasChanged();
